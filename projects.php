...
<div class="container main-content" >
 ...
 <th >Client
 <span ng-click="order = 'client'" class="glyphicon glyphicon-menu-up"></span>
 <span ng-click="order = '-client'" class="glyphicon glyphicon-menu-down"></span>
 </th >
 <th >Status</th >
 </tr >
 ...
 <dt >client</dt >
 <dd >{{portfolio.selectedProject.client}}</dd >
 <dt >created</dt >
...
<script type="text/javascript" src="bower_components/angular-auto-validate/dist/jcs-auto-validate.min.js" ></script >
...
<script type="text/javascript" src="bower_components/ng-resource/dist/ng-resource.min.js"></script>
